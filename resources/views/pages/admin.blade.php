                ...
                @foreach ($cars as $car)
                    <li>
                        <div class="p-5 flex justify-between text-black dark:text-white border border-black/20 dark:border-white/20 rounded-md transition-all hover:border-black/40 hover:dark:border-white/40">
                            ...
                            <a href="{{ route('car.show', ['id' => $car->id]) }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 flex items-center justify-center dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Просмотр</a>
                        </div>
                    </li>
                @endforeach
            </ul>
