    ...
    <div class="flex gap-10">
        <div class="w-2/3 space-y-10">
            <form method="post" action="{{ route('cart.clear') }}">
                ...
                @csrf
                <button type="submit" class="w-full flex items-center justify-center gap-2 py-3.5 font-medium text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        ...
        <div class="w-1/3">
            <div class="w-full p-5 bg-gray-200 dark:bg-[#14181d] rounded-md border-black/20 dark:border-black border text-black dark:text-white space-y-2">
                ...
                <p class="font-semibold">
                    Итоговая стоимость: <span>{{ $totalPrice }}</span> ₽
                </p>
                ...
                <form action="{{ route('order.store') }}" class="space-y-4" method="post">
                    ...
                    <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm w-full py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Оформить заказ</button>
                </form>
            </div>
        </div>
    </div>
